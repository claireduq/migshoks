...
keep jurisdictionaor dateenacted
save $Data_built\sanctuary_cities.dta, replace
...
append using $Data_built\sanctuary_cities.dta
save $Data_built\sanctuary_cities.dta, replace
sleep 200
clear
}

use $Data_built\sanctuary_cities.dta, clear
...
save $Data_built\sancturay_cities_wide.dta, replace

cap erase "$Data_built\sanctuary_cities.dta"
...
reghdfe net_3m  f24_sc_5 f12_sc_5 sc_shock_5 l12_sc_5 l24_sc_5 l36_sc_5 c.migr_share#i.time_yq [aw=fac] if hh_vari ==1 , a($fehhvari) cluster(geo2_mx2000)

reghdfe migr_3m  f24_sc_5 f12_sc_5 sc_shock_5 l12_sc_5 l24_sc_5 l36_sc_5 c.migr_share#i.time_yq [aw=fac] if hh_vari ==1 , a($fehhvari) cluster(geo2_mx2000)

reghdfe will_migrate  f24_sc_5 f12_sc_5 sc_shock_5 l12_sc_5 l24_sc_5 l36_sc_5  [aw=fac] if ind_bsline==1 , a($fe) cluster(geo2_mx2000)


foreach y in 1 2 3 4 5 {
reghdfe enroll  f24_sc_5 f12_sc_5 sc_shock_5 l12_sc_5 l24_sc_5 l36_sc_5 c.migr_share#i.time_yq [aw=fac] if age_group==`y' & ind_bsline==1, a($fe) cluster(geo2_mx2000)
}

foreach y in 1 2 3 4 5 {
reghdfe lfp  f24_sc_5 f12_sc_5 sc_shock_5 l12_sc_5 l24_sc_5 l36_sc_5 c.migr_share#i.time_yq [aw=fac] if age_group==`y', a($fe) cluster(geo2_mx2000)
}


reghdfe lfp f24_sc_5 f12_sc_5 sc_shock_5 l12_sc_5 l24_sc_5 l36_sc_5 c.migr_share#i.int_year [aw=fac] if eda<=17, a($fe) cluster(geo2_mx2000)

reghdfe study f36_sc_5 f24_sc_5 f12_sc_5 sc_shock_5 l12_sc_5 l24_sc_5 l36_sc_5 c.migr_share#i.int_year [aw=fac] if eda>=15 & eda<=17, a($fe) cluster(geo2_mx2000)

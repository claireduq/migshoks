...
replace home0vaway_ent_`i'=. if indiv_notalive1_`i'==1
replace home0vaway_ent_`i'=. if hh_attrit1no0_ent_`i'==1
replace home0vaway_ent_`i'=. if indiv_attrit1no0_ent_`i'==1
...
keep indiv_id  first_int_yq home0vaway_ent_*  mex0vabroad_ent_* indiv_attrit1no0_ent_* hh_fac_*
duplicates drop
reshape long mex0vabroad_ent_  home0vaway_ent_ indiv_attrit1no0_ent_ hh_fac_ , i(indiv_id) j(n_ent)

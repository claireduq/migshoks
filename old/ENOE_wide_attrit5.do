...
keep hh_id  qy_ent1 y_ent1 q_ent1 geo1_mx2000 geo2_mx2000 yoy_hhattrits  hh_fac_1 hh_fac_5 yoy_hhdeparts yoy_hharrives
duplicates drop
isid hh_id
...
collapse (sum) yoy_hhattrits yoy_hhdeparts yoy_hharrives, by(geo1_mx2000 geo2_mx2000 y_ent q_ent)
merge m:1  y_ent q_ent  geo2_mx2000 using Data_built\Matriculas\Shock_Mat_SecComm_Sanc_5merge.dta
drop _m 
rename ( yoy_hhattrits yoy_hhdeparts yoy_hharrives)( yoy_muni_hhattrits yoy_muni_hhdeparts yoy_muni_hharrives)
...
save Data_built\ENOE\muni_attrit_FD.dta, replace
...
global fe  i.y_ent##i.geo1_mx2000 


*with weights this conditions on hh being observed in first ent (departures=1 stay=0)
reghdfe yoy_hhdeparts yoy_sc_shock_5 c.migr_share#i.y_ent [aw=hh_fac_1], a($fe) cluster(geo2_mx2000)

reghdfe yoy_hhdeparts yoy_sc_shock_5 c.migr_share#i.y_ent if hh_fac_1!=., a($fe) cluster(geo2_mx2000)
...
use Data_built\ENOE\muni_attrit_FD.dta
*households less likely to disappear, more likely to join. FD approach
global fe  i.y_ent##i.geo1_mx2000 

reghdfe yoy_muni_hhdeparts yoy_sc_shock_5 c.migr_share#i.y_ent [aw=persons], a($fe) cluster(geo2_mx2000)

reghdfe yoy_muni_hharrives yoy_sc_shock_5 c.migr_share#i.y_ent [aw=persons], a($fe) cluster(geo2_mx2000)

reghdfe yoy_muni_hhattrits yoy_sc_shock_5 c.migr_share#i.y_ent [aw=persons], a($fe) cluster(geo2_mx2000)

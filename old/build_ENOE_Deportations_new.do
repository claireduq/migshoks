...
gen int_moyr=ym(d_anio+2000,d_mes)
...
replace this_or_last_yr=1 if `i'==d_anio+2000
replace this_or_last_yr=1 if `i'==d_anio+2000-1
...
save Data_built\ENOE\ENOE_deport_shock_windows_new.dta, replace

use Data_built\ENOE\deport_shock_new_construct.dta

merge 1:1 geo2_mx2000 year month using Data_built\EMIF\Shock_EMIF_SecComm_Sanc_4.dta
keep if _m==3
drop _m

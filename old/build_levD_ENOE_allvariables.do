...
collapse (mean) inc_mo hh_earn_mo logwage wage_* anios_esc ls_dum* lfp unempl ls_hrs migrant dom_migrant returned dom_returned (sum) pop emp_n_un_low emp_n_un_high emp_n_un_1518 emp_n_un_old emp_n_un_old_low emp_n_un_old_high migr_3m return_3m [pw=fac] , by(per year geo2_mx2000 geo1_mx2000)
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) study lfp unempl ls_hrs wage_hr inc_mo chores study_hrs enroll migrant dom_migrant returned dom_returned yrs_offtrack female (sum) students=study enrolled=enroll [pw=fac], by(geo2_mx2000 quarter year)
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) study lfp unempl ls_hrs chores study_hrs enroll migrant dom_migrant returned dom_returned yrs_offtrack wage_hr (sum) students=study enrolled=enroll [pw=fac], by(geo2_mx2000 quarter year)
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) study lfp unempl ls_hrs chores chores_hrs study_hrs enroll migrant  dom_migrant  returned dom_returned yrs_offtrack female wage_hr (sum) students=study enrolled=enroll [pw=fac], by(geo2_mx2000 quarter year)
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) study lfp unempl ls_hrs chores chores_hrs study_hrs enroll migrant  dom_migrant  returned dom_returned yrs_offtrack female wage_hr wage_loweduc wage_higheduc (sum) students=study enrolled=enroll [pw=fac], by(geo2_mx2000 quarter year)
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) lfp unempl ls_hrs   migrant dom_migrant   returned dom_returned female wage_hr wage_loweduc wage_higheduc  [pw=fac], by(geo2_mx2000 quarter year)
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) lfp unempl ls_hrs hrs  migrant  dom_migrant  returned dom_returned  female wage_hr wage_loweduc wage_higheduc (sum) observed [pw=fac], by(geo2_mx2000 quarter year)
rename ( lfp unempl ls_hrs  migrant dom_migrant returned dom_returned female wage_hr wage_loweduc wage_higheduc) ///
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) study lfp unempl ls_hrs chores chores_hrs study_hrs enroll migrant yrs_offtrack female wage_hr (sum) students=study enrolled=enroll [pw=fac], by(geo2_mx2000 quarter year)
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) lfp unempl ls_hrs enroll migrant  female wage_hr (sum) observed [pw=fac], by(geo2_mx2000 quarter year)

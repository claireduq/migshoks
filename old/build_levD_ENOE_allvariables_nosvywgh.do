...
keep loc mun est est_d ageb t_loc cd_a ent con upm d_sem n_pro_viv v_sel n_hog ///
	...
	ing_x_hrs hhsize cohabsib birthorder par_c d_dia d_mes d_anio c_res ///
	 n_ent  first_int_yq migrated returned late_yr_birth anios_esc dom_migrated dom_returned dom_return_3m dom_migr_3m  any_migrant_3m any_dom_migrant_3m any_return_3m  any_dom_return_3m cs_ad_des cs_nr_ori migrant match dom_migrant
...
sort indiv_id
by indiv_id: egen has_returned=total(returned)
replace has_returned=1 if has_returned>1

sort indiv_id
by indiv_id: egen has_dom_returned=total(dom_returned)
...
sort hh_id
by hh_id: egen hh_has_return=total(returned)
replace  hh_has_return=1 if  hh_has_return>=1

sort hh_id
by hh_id: egen hh_has_dom_return=total(dom_returned)
...
collapse (mean) inc_mo hh_earn_mo logwage wage_* anios_esc ls_dum* lfp unempl ls_hrs migrant dom_migrant returned dom_returned (sum) pop emp_n_un_low emp_n_un_high emp_n_un_1518 emp_n_un_old emp_n_un_old_low emp_n_un_old_high migr_3m return_3m  , by(per year geo2_mx2000 geo1_mx2000)
tostring per, gen(quarter)
replace quarter=substr(quarter, 1, 1)
destring quarter, replace
...
save Data_built\ENOE\ENOE_muncontrols_2000_nosvywgh.dta, replace
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005
collapse (sum) pop  , by(per year geo2_mx2000 geo1_mx2000)
rename pop mun_totalpop 
label var mun_total "Municipality population"
merge 1:1 per year geo2_mx2000 geo1_mx2000 using Data_built\ENOE\ENOE_muncontrols_2000_nosvywgh.dta
drop _m
save Data_built\ENOE\ENOE_muncontrols_2000_nosvywgh.dta, replace
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) migr_3m any_migrant hh_has_migrant , by(per geo2_mx2000)
...
save Data_built\ENOE\munmigration_nosvywgh.dta, replace
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) study lfp unempl ls_hrs wage_hr inc_mo chores study_hrs enroll migrant dom_migrant returned dom_returned yrs_offtrack female (sum) students=study enrolled=enroll , by(geo2_mx2000 quarter year)
rename (study lfp unempl ls_hrs wage_hr inc_mo chores study_hrs enroll migrant dom_migrant returned dom_returned yrs_offtrack female ) ///
(study_12to20 lfp_12to20 unempl_12to20 ls_hrs_12to20 wage_hr_12to20 inc_mo_12to20 chores_12to20 study_hrs_12to20 enroll_12to20 migrant_12to20 dom_migrant_12to20 returned_12to20 dom_returned_12to20 yrs_offtrack_12to20 female_12to20)
gen logenroll_12to20=log(enrolled)
gen logstudents_12to20=log(students)
cap drop students enrolled
save Data_built\ENOE\ENOE_timeuse_munbyquarter_12to20_nosvywgh.dta, replace
*females
use Data_built\ENOE\time_use_all_merge, clear
gen geo2_mx2015 = ent*1000 + mun
keep if eda<=20
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) study lfp unempl ls_hrs chores study_hrs enroll migrant dom_migrant returned dom_returned yrs_offtrack wage_hr (sum) students=study enrolled=enroll, by(geo2_mx2000 quarter year)
rename (study lfp unempl ls_hrs  chores study_hrs enroll migrant dom_migrant returned dom_returned yrs_offtrack wage_hr ) ///
(study_12to20_f lfp_12to20_f unempl_12to20_f ls_hrs_12to20_f chores_12to20_f study_hrs_12to20_f enroll_12to20_f migrant_12to20_f dom_migrant_12to20_f returned_12to20_f dom_returned_12to20_f yrs_offtrack_12to20_f wage_hr_12to20_f)
gen logenroll_females=log(enrolled)
gen logstudents_females=log(students)
cap drop students enrolled
save Data_built\ENOE\ENOE_timeuse_munbyquarter_fem_nosvywgh.dta, replace
...
collapse (mean) study lfp unempl ls_hrs chores study_hrs enroll migrant  dom_migrant  returned dom_returned yrs_offtrack wage_hr (sum) students=study enrolled=enroll , by(geo2_mx2000 quarter year)
rename (study lfp unempl ls_hrs  chores study_hrs enroll migrant dom_migrant returned dom_returned yrs_offtrack wage_hr ) ///
(study_12to20_m lfp_12to20_m unempl_12to20_m ls_hrs_12to20_m chores_12to20_m study_hrs_12to20_m enroll_12to20_m migrant_12to20_m dom_migrant_12to20_m returned_12to20_m dom_returned_12to20_m yrs_offtrack_12to20_m wage_hr_12to20_m)
gen logenroll_males=log(enrolled)
gen logstudents_males=log(students)
cap drop students enrolled
save Data_built\ENOE\ENOE_timeuse_munbyquarter_males_nosvywgh.dta, replace
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) study lfp unempl ls_hrs chores chores_hrs study_hrs enroll migrant  dom_migrant  returned dom_returned yrs_offtrack female wage_hr (sum) students=study enrolled=enroll , by(geo2_mx2000 quarter year)
rename (study lfp unempl ls_hrs chores chores_hrs study_hrs enroll migrant dom_migrant  returned dom_returned  yrs_offtrack female wage_hr) ///
(study_12to14 lfp_12to14 unempl_12to14 ls_hrs_12to14 chores_12to14 chores_hrs_12to14 study_hrs_12to14 enroll_12to14 migrant_12to14 dom_migrant_12to14  returned_12to14  dom_returned_12to14   yrs_offtrack_12to14 female_12to14 wage_hr_12to14)
gen logenroll_12to14=log(enrolled)
gen logstudents_12to14=log(students)
cap drop students enrolled
save Data_built\ENOE\ENOE_timeuse_munbyquarter_12to14_nosvywgh.dta, replace
...
collapse (mean) study lfp unempl ls_hrs chores chores_hrs study_hrs enroll migrant dom_migrant  returned dom_returned  yrs_offtrack female wage_hr (sum) students=study enrolled=enroll, by(geo2_mx2000 quarter year)
rename (study lfp unempl ls_hrs chores chores_hrs study_hrs enroll migrant dom_migrant  returned dom_returned  yrs_offtrack female wage_hr) ///
(study_15to17 lfp_15to17 unempl_15to17 ls_hrs_15to17 chores_15to17 chores_hrs_15to17 study_hrs_15to17 enroll_15to17 migrant_15to17 dom_migrant_15to17  returned_15to17 dom_returned_15to17  yrs_offtrack_15to17 female_15to17 wage_hr_15to17)
gen logenroll_15to17=log(enrolled)
gen logstudents_15to17=log(students)
cap drop students enrolled
save Data_built\ENOE\ENOE_timeuse_munbyquarter_15to17_nosvywgh.dta, replace
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) study lfp unempl ls_hrs chores chores_hrs study_hrs enroll migrant  dom_migrant  returned dom_returned yrs_offtrack female wage_hr wage_loweduc wage_higheduc (sum) students=study enrolled=enroll , by(geo2_mx2000 quarter year)
rename (study lfp unempl ls_hrs chores chores_hrs study_hrs enroll migrant dom_migrant  returned dom_returned  yrs_offtrack female wage_hr wage_loweduc wage_higheduc) ///
(study_18to20 lfp_18to20 unempl_18to20 ls_hrs_18to20 chores_18to20 chores_hrs_18to20 study_hrs_18to20 enroll_18to20 migrant_18to20 dom_migrant_18to20  returned_18to20 dom_returned_18to20  yrs_offtrack_18to20 female_18to20 wage_hr_18to20 wage_loweduc_18to20 wage_higheduc_18to20)
gen logenroll_18to20=log(enrolled)
gen logstudents_18to20=log(students)
cap drop students enrolled
save Data_built\ENOE\ENOE_timeuse_munbyquarter_18to20_nosvywgh.dta, replace
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) lfp unempl ls_hrs   migrant dom_migrant   returned dom_returned female wage_hr wage_loweduc wage_higheduc  , by(geo2_mx2000 quarter year)
rename ( lfp unempl ls_hrs  migrant dom_migrant  returned dom_returned female wage_hr wage_loweduc wage_higheduc) ///
( lfp_21to35 unempl_21to35 ls_hrs_21to35 migrant_21to35 dom_migrant_21to35   returned_21to35 dom_returned_21to35   female_21to35 wage_hr_21to35 wage_loweduc_21to35 wage_higheduc_21to35)
save Data_built\ENOE\ENOE_timeuse_munbyquarter_21to35_nosvywgh.dta, replace
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) lfp unempl ls_hrs hrs  migrant  dom_migrant  returned dom_returned  female wage_hr wage_loweduc wage_higheduc (sum) observed , by(geo2_mx2000 quarter year)
rename ( lfp unempl ls_hrs  migrant dom_migrant returned dom_returned female wage_hr wage_loweduc wage_higheduc) ///
( lfp_21plus unempl_21plus ls_hrs_21plus migrant_21plus dom_migrant_21plus returned_21plus dom_returned_21plus female_21plus wage_hr_21plus wage_loweduc_21plus wage_higheduc_21plus)
gen logobs_21plus=log(observed)
save Data_built\ENOE\ENOE_timeuse_munbyquarter_21plus_nosvywgh.dta, replace
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) study lfp unempl ls_hrs chores chores_hrs study_hrs enroll migrant yrs_offtrack female wage_hr (sum) students=study enrolled=enroll , by(geo2_mx2000 quarter year)
rename ( lfp unempl ls_hrs  migrant female wage_hr ) ///
( lfp_ent1_erld_und18 unempl_ent1_erld_und18 ls_hrs_ent1_erld_und18 migrant_ent1_erld_und18 female_ent1_erld_und18 wage_hr_ent1_erld_und18)
gen logenroll_ent1_erld_und18=log(enrolled)
gen logstudents_ent1_erld_und18=log(students)
cap drop students enrolled
save Data_built\ENOE\ENOE_timeuse_munbyquarter_ent1_erld_und18_nosvywgh.dta, replace
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) lfp unempl ls_hrs enroll migrant  female wage_hr (sum) observed , by(geo2_mx2000 quarter year)
rename (  lfp unempl ls_hrs enroll migrant female wage_hr ) ///
( lfp_ent1_drp_und18 unempl_ent1_drp_und18 ls_hrs_ent1_drp_und18 enroll_ent1_drp_und18 migrant_ent1_drp_und18 female_ent1_drp_und18 wage_hr_ent1_drp_und18)
gen logobs_ent1_drp_und18=log(observed)
cap drop observed
save Data_built\ENOE\ENOE_timeuse_munbyquarter_ent1_drp_und18_nosvywgh.dta, replace
...
drop if _m==2 // not all municipalities coevered in any round? 
drop _m geo1_mx2015 geo1_mx2010 geo2_mx2010 geo1_mx2005 geo2_mx2005 
collapse (mean) any_migrant_3m any_return_3m any_dom_migrant_3m any_dom_return_3m hh_has_migrant hh_has_dom_migrant hh_earn_mo got_remit_3m hhv_* hhsize, by(geo2_mx2000 quarter year)
save Data_built\ENOE\ENOE_timeuse_munbyquarter_hh_nosvywgh.dta, replace

** merge, add controls and shock variable
use Data_built\ENOE\ENOE_timeuse_munbyquarter_hh_nosvywgh.dta, clear

merge m:1 geo2_mx2000 quarter year using Data_built\ENOE\ENOE_timeuse_munbyquarter_12to20_nosvywgh.dta
drop _m
merge m:1 geo2_mx2000 quarter year using Data_built\ENOE\ENOE_timeuse_munbyquarter_fem_nosvywgh.dta
drop _m
merge m:1 geo2_mx2000 quarter year using Data_built\ENOE\ENOE_timeuse_munbyquarter_males_nosvywgh.dta
drop _m
merge m:1 geo2_mx2000 quarter year using Data_built\ENOE\ENOE_timeuse_munbyquarter_12to14_nosvywgh.dta
drop _m
merge m:1 geo2_mx2000 quarter year using Data_built\ENOE\ENOE_timeuse_munbyquarter_15to17_nosvywgh.dta
drop _m
merge m:1 geo2_mx2000 quarter year using Data_built\ENOE\ENOE_timeuse_munbyquarter_18to20_nosvywgh.dta
drop _m
merge m:1 geo2_mx2000 quarter year using Data_built\ENOE\ENOE_timeuse_munbyquarter_21to35_nosvywgh.dta
drop _m
merge m:1 geo2_mx2000 quarter year using Data_built\ENOE\ENOE_timeuse_munbyquarter_21plus_nosvywgh.dta
drop _m
merge m:1 geo2_mx2000 quarter year using Data_built\ENOE\ENOE_timeuse_munbyquarter_ent1_erld_und18_nosvywgh.dta
drop _m
merge m:1 geo2_mx2000 quarter year using Data_built\ENOE\ENOE_timeuse_munbyquarter_ent1_drp_und18_nosvywgh.dta
drop _m
...
save Data_built\ENOE\ENOE_timeuse_shock_munbyquarter_nosvywgh.dta, replace

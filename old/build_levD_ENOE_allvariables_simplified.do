...
*this file comes from ENOE_wide_attrit6 which takes ENOE_timeuse_shock_all.dta as an input_Make so can run all as one file. 
...
keep hh_id qy_ent* y_ent* q_ent* geo1_mx2000 geo2_mx2000 hh_home1vaway_ent_*  hh_shouldbe_int*
duplicates drop

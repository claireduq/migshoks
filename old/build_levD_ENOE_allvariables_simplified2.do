...
*Data_raw\ENOE\COE1T`x'`y'.dta
*Data_built\Matriculas\Shock_Mat_SecComm_Sanc_all.dta
*Data_built\Claves\Claves_1960_2015.dta

*Generates
*Data_built\ENOE\time_use_all_merge.dta
*Data_built\ENOE\ENOE_muniagg_prog.dta
...
foreach x in 1 2 3 4 {
foreach y in 05 06 07 08 09 10 11 12 13 14 15 16 17 18 {
cap erase Data_built\ENOE\socioT`x'`y'_all.dta
}
}
*
...
merge 1:m indiv_id using  Data_built\ENOE\time_use_all_merge
drop _m 
...
merge 1:1 geo2_mx2000 quarter year using Data_built\ENOE\ENOE_muniagghhent1.dta
drop _m

merge 1:1 geo2_mx2000 quarter year using Data_built\ENOE\ENOE_muniagghhent5.dta
drop _m
...
cap erase "Data_built\ENOE\ENOE_muniagg`y'.dta"
}
*
